...
public static class CliHelp
{
    public static void Print()
    {
        ...
        Console.WriteLine("  --export-rule-coverage   Export rule coverage documentation and exit");
        Console.WriteLine("  --rule-coverage          Short alias for --export-rule-coverage");
        ...
        Console.WriteLine("  dotnet run --project src\\PurpleTrace.Agent -- --export-rule-coverage docs/rule-coverage.md --rules rules");
